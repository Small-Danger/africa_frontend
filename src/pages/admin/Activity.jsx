...
const actionBadge = (action) => {
  ...
  if (action === 'stock.receipt_cancelled' || action === 'stock.reservation_expired' || action === 'stock.preorder_cancelled' || action === 'order.expired' || action === 'order.cancelled') return 'destructive';
  return 'secondary';
};
